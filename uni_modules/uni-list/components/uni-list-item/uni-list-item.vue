...
export default {
  ...
  methods: {
    ...
    openPage() {
      if (['navigateTo', 'redirectTo', 'reLaunch', 'switchTab'].includes(this.link))
  ...
  <cell :keep-scroll-position="keepScrollPosition">
    ...
    >
      ...
      >
        ...
        <slot name="footer">
          <view
            v-if="rightText || showBadge || showSwitch" class="uni-list-item__extra" :class="{ 'flex--justify': direction === 'column' }
