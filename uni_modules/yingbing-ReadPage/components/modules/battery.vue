				...
				uni.getSystemInfo({
					success: (res) => {
						if ( res.osName == 'android' ) {
							const recevier = plus.android.implements('io.dcloud.feature.internal.reflect.BroadcastReceiver', { 
							...
							const filter = new IntentFilter(Intent.ACTION_BATTERY_CHANGED); 
